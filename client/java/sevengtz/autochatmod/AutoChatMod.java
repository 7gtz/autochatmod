...
import net.fabricmc.fabric.api.client.rendering.v1.HudElementRegistry; // New Import
...
public class AutoChatMod implements ClientModInitializer {
    ...
    private static final Identifier ACTION_MENU_ID = new Identifier(MOD_ID, "action_menu");
    ...
    public void onInitializeClient() {
        ...
        HudElementRegistry.register(ACTION_MENU_ID, ACTION_MENU);
